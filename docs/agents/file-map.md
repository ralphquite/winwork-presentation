...
| `src/presentation/config/api.ts`                       | Ordered nine-scene API / Embedded route with stable sparse scene IDs                  | Matching HTML exports                                      |
| `src/presentation/config/small.ts`                     | Ordered 13-scene Small Business route and reused single-task binding                  | Matching HTML exports and demo-flow binding                |
